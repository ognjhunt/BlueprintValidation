...
from ..enrichment.stage2_quality import (
    CoverageGateResult,
    analyze_target_visibility as _shared_stage2_analyze_target_visibility,
    analyze_output_visual_quality as _analyze_output_visual_quality,
    evaluate_stage1_coverage_gate as _evaluate_stage1_coverage_gate,
    read_video_frame as _read_video_frame,
    resolve_clip_context_selection as _resolve_clip_context_selection,
)
...
from ..evaluation.expected_focus import resolve_expected_focus_text as _resolve_expected_focus_text
...
def _analyze_target_visibility(
    ...
    return _shared_stage2_analyze_target_visibility(
