"""Runtime backend kinds and metadata helpers."""
...
RuntimeBackendKind = Literal["smoke_contract", "neoverse_production"]

DEFAULT_RUNTIME_BACKEND_KIND: RuntimeBackendKind = "neoverse_production"
KNOWN_RUNTIME_BACKEND_KINDS = {"smoke_contract", "neoverse_production"}
...
def normalize_runtime_kind(value: object, *, default: RuntimeBackendKind = DEFAULT_RUNTIME_BACKEND_KIND) -> RuntimeBackendKind:
...
def parse_runtime_metadata(payload: Mapping[str, Any]) -> RuntimeMetadata:
    ...
    return RuntimeMetadata(
        ...
        service=str(payload.get("service") or "neoverse-runtime"),
