"""Customer-facing helpers for session/runtime reporting."""
...
_PUBLIC_RUNTIME_LABELS = {
    "native_world_model": "Native world-model runtime",
    "site_world_runtime": "Site-world runtime",
